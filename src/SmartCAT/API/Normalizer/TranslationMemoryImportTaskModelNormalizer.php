...
class TranslationMemoryImportTaskModelNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'SmartCAT\\API\\Model\\TranslationMemoryImportTaskModel') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \SmartCAT\API\Model\TranslationMemoryImportTaskModel) {
            return true;
        }
        return false;
    }
    ...
    {
        $object = new \SmartCAT\API\Model\TranslationMemoryImportTaskModel();
