...
class TranslationMemoryModelNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'SmartCAT\\API\\Model\\TranslationMemoryModel') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \SmartCAT\API\Model\TranslationMemoryModel) {
            return true;
        }
        return false;
    }
    ...
    {
        $object = new \SmartCAT\API\Model\TranslationMemoryModel();
